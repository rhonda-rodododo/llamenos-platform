/**
 * Pure-TypeScript fallback for @llamenos/crypto/ffi.
 *
 * Used when the Bun runtime is not available (Node.js, Playwright, bddgen).
 * Implements the same contract using @noble/curves and @noble/hashes.
 */
