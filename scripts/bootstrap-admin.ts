...
console.log('1. Set both public keys as Cloudflare secrets:')
...
console.log('3. The admin logs in with the IDENTITY nsec.')
console.log('4. The admin imports the DECRYPTION nsec to decrypt notes.')
