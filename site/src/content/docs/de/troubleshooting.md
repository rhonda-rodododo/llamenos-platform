...
STORAGE_ACCESS_KEY=ihr_rustfs_zugangsschluessel
STORAGE_SECRET_KEY=ihr_rustfs_geheimschluessel
...
- Ueberpruefen Sie, ob `STORAGE_ACCESS_KEY` und `STORAGE_SECRET_KEY` korrekt sind
