...
احفظ **nsec** بشكل آمن. انسخ **المفتاح العام بصيغة hex** لقيم Helm.
...
|---------|--------|-----------|
| `app.image.repository` | صورة الحاوية | `ghcr.io/your-org/llamenos` |
...
| المعامل | الوصف | الافتراضي |
|---------|--------|-----------|
| `secrets.adminPubkey` | المفتاح العام Nostr hex للمسؤول | `""` |
...
للتوسع التلقائي العالمي بدون إدارة البنية التحتية، فكر في [نشر Cloudflare Workers](/docs/getting-started).
