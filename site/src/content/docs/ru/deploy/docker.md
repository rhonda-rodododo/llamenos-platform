...
Вам потребуется пара ключей WebSocket для учётной записи администратора. Выполните это на локальном компьютере (или на сервере, если установлен Bun):
...
Вам нужна ключевая пара WebSocket для учётной записи администратора. Выполните на локальной машине (или на сервере, если Bun установлен):
