...
S3_ACCESS_KEY=tu-clave-de-acceso
S3_SECRET_KEY=tu-clave-secreta-min-8-caracteres
```
...
Para telefonia SIP autoalojada (ver [configuracion de Asterisk](/docs/deploy/providers/asterisk)):
...
Para mensajeria Signal (ver [configuracion de Signal](/docs/deploy/providers/signal)):
