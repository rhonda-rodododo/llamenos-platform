...
|--------|-----------|-------------|---------------|
| [Cloudflare Workers](/docs/deploy) | Inicio mas facil, edge global | Baja | Automatica |
...
- **Asterisk** — para telefonia SIP autoalojada (ver [configuracion de Asterisk](/docs/deploy/providers/asterisk))
- **Bridge Signal** — para mensajeria Signal (ver [configuracion de Signal](/docs/deploy/providers/signal))
...
- [Primeros Pasos](/docs/deploy) — despliegue en Cloudflare Workers
