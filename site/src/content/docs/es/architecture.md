...
- **llamenos-mobile** -- La aplicacion movil React Native para iOS y Android. Usa bindings UniFFI para invocar el mismo codigo Rust de criptografia.
...
- Las 25 constantes de separacion de dominio criptografico definidas en `crypto-labels.ts` previenen ataques entre protocolos
