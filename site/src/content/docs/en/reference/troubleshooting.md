...
- Verify that the update endpoint is reachable: `https://github.com/rhonda-rodododo/llamenos-hotline/releases/latest/download/latest.json`
...
- Check the [GitHub Issues](https://github.com/rhonda-rodododo/llamenos-hotline/issues) for known bugs and workarounds
