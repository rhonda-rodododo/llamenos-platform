...
The mobile app lives in a separate repository (`llamenos-mobile`) but shares:
...
1. Download the latest `.apk` file from the [GitHub Releases](https://github.com/rhonda-rodododo/llamenos-mobile/releases/latest) page
