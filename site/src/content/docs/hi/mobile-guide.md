...
मोबाइल ऐप एक अलग repository (`llamenos-mobile`) में रहता है लेकिन यह साझा करता है:
...
1. [GitHub Releases](https://github.com/rhonda-rodododo/llamenos-mobile/releases/latest) page से नवीनतम `.apk` file download करें
