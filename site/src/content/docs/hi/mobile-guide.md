...
मोबाइल ऐप एक अलग repository (`llamenos-platform`) में रहता है लेकिन यह साझा करता है:
...
1. [GitHub Releases](https://github.com/rhonda-rodododo/llamenos-platform/releases/latest) page से नवीनतम `.apk` file download करें
