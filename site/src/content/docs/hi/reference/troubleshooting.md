...
# जांचें कि port 9000 (MinIO) का उपयोग कौन कर रहा है
sudo lsof -i :9000
```
...
### MinIO / S3 storage त्रुटियाँ

- सत्यापित करें कि `MINIO_ACCESS_KEY` और `MINIO_SECRET_KEY` सही हैं
- जांचें कि MinIO कंटेनर चल रहा है: `docker compose ps minio`
- Bucket निर्माण सत्यापित करने के लिए `http://localhost:9001` पर MinIO console एक्सेस करें
