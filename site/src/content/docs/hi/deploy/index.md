...
एडमिन अकाउंट के लिए एक WebSocket कीपेयर जनरेट करें। यह एक सीक्रेट की (nsec) और पब्लिक की (npub/hex) उत्पन्न करता है।
...
स्थानीय विकास के लिए प्रोजेक्ट रूट में `.env` फ़ाइल बनाएँ। यह उदाहरण Twilio का उपयोग करता है — यदि आप किसी अन्य प्रदाता का उपयोग कर रहे हैं, तो आप Twilio वेरिएबल्स को छोड़ सकते हैं और पहले लॉगिन के बाद एडमिन UI से अपने प्रदाता को कॉन्फ़िगर कर सकते हैं।
