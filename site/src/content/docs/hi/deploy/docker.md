...
> **महत्वपूर्ण**: `PG_PASSWORD`, `S3_ACCESS_KEY`, और `S3_SECRET_KEY` के लिए मजबूत, अद्वितीय पासवर्ड सेट करें।
...
स्व-होस्टेड SIP telephony के लिए (देखें [Asterisk setup](/docs/deploy/providers/asterisk)):
...
Signal messaging के लिए (देखें [Signal setup](/docs/deploy/providers/signal)):

```bash
docker compose --profile signal up -d
```

आपको signal-cli container के माध्यम से Signal number register करना होगा। निर्देशों के लिए [Signal setup guide](/docs/deploy/providers/signal) देखें।
