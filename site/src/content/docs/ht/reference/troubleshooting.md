...
- Verifye `S3_ACCESS_KEY` ak `S3_SECRET_KEY` kòrèk
...
- Verifye pwen finisman mizajou aksesib : `https://github.com/rhonda-rodododo/llamenos/releases/latest/download/latest.json`
...
- Verifye [GitHub Issues](https://github.com/rhonda-rodododo/llamenos/issues) pou bug ki konnen ak solisyon travay
