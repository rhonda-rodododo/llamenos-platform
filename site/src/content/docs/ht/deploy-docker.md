...
Pou telefoni SIP otojere (gade [Konfigirasyon Asterisk](/docs/setup-asterisk)):
...
Pou mesajri Signal (gade [Konfigirasyon Signal](/docs/setup-signal)):

```bash
docker compose --profile signal up -d
```

W ap bezwen anrejistre nimewo Signal la nan kontenè signal-cli a. Gade [gid konfigirasyon Signal](/docs/setup-signal) pou enstriksyon.
...
- [Apèsi Ebèjman Pa Ou Menm](/docs/self-hosting) — konpare opsyon deplwaman
