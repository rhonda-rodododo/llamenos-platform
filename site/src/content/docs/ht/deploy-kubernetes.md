...
Pou eskalad mondyal otomatik san jere enfrastriktirè, konsidere [depoze Cloudflare Workers](/docs/getting-started).
...
- [Apèsi Otojere](/docs/self-hosting) — konpare opsyon depoze yo
