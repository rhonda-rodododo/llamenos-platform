...
Konekte ak `nsec` (kle sekrè WebSocket) ki te jenere pandan [enstalasyon](/docs/deploy) an. Paj koneksyon an aksepte fòma nsec (`nsec1...`). Navigatè ou a siyen yon defi ak kle a -- sekrè a pa janm kite aparèy la.
...
- **Ajoute yon volontè** -- sa jenere yon nouvo WebSocket keypair. Pataje nsec la ak volontè a an sekirite (li parèt yon sèl fwa).
