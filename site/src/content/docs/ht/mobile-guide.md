...
Aplikasyon mobil la viv nan yon depo separe (`llamenos-mobile`) men pataje:
...
1. Telechaje dènye fichye `.apk` soti nan paj [GitHub Releases](https://github.com/rhonda-rodododo/llamenos-mobile/releases/latest) la
