...
| 选项 | 最适合 | 复杂度 | 扩展性 |
|------|--------|--------|--------|
| [Cloudflare Workers](/docs/deploy) | 最简单的入门，全球边缘 | 低 | 自动 |
...
- **Asterisk** —— 用于自托管 SIP 电话服务（请参阅 [Asterisk 配置](/docs/deploy/providers/asterisk)）
- **Signal 桥接** —— 用于 Signal 消息功能（请参阅 [Signal 配置](/docs/deploy/providers/signal)）
...
- [快速入门](/docs/deploy) —— Cloudflare Workers 部署
