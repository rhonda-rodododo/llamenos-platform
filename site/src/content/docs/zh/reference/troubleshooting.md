...
- 检查您的互联网连接
- 验证更新端点是否可访问：`https://github.com/rhonda-rodododo/llamenos-hotline/releases/latest/download/latest.json`
...
- 检查 [GitHub Issues](https://github.com/rhonda-rodododo/llamenos-hotline/issues) 了解已知的 bug 和解决方法
