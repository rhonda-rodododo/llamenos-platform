...
Faca login com o `nsec` (chave secreta WebSocket) gerado durante a [configuracao](/docs/deploy). A pagina de login aceita o formato nsec (`nsec1...`). Seu navegador assina um desafio com a chave -- o segredo nunca sai do dispositivo.
...
- **Adicionar um voluntario** -- gera um novo par de chaves WebSocket. Compartilhe o nsec de forma segura com o voluntario (ele e exibido apenas uma vez).
