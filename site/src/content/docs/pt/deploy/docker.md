...
S3_ACCESS_KEY=sua-chave-de-acesso
S3_SECRET_KEY=sua-chave-secreta-min-8-chars
```

> **Importante**: Defina senhas fortes e unicas para `PG_PASSWORD`, `S3_ACCESS_KEY` e `S3_SECRET_KEY`.
