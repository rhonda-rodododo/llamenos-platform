...
O aplicativo movel esta em um repositorio separado (`llamenos-mobile`), mas compartilha:
...
1. Baixe o arquivo `.apk` mais recente na pagina de [GitHub Releases](https://github.com/rhonda-rodododo/llamenos-mobile/releases/latest)
