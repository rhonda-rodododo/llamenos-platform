...
- Verifique se o endpoint de atualizacao esta acessivel: `https://github.com/rhonda-rodododo/llamenos-hotline/releases/latest/download/latest.json`
...
- Verifique as [Issues do GitHub](https://github.com/rhonda-rodododo/llamenos-hotline/issues) para bugs conhecidos e solucoes alternativas
