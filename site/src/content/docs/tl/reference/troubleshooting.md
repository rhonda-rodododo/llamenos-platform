...
- I-verify na tama ang `S3_ACCESS_KEY` at `S3_SECRET_KEY`
...
- I-verify na maabot ang update endpoint: `https://github.com/rhonda-rodododo/llamenos/releases/latest/download/latest.json`
...
- Suriin ang [GitHub Issues](https://github.com/rhonda-rodododo/llamenos/issues)
