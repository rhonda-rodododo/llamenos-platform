...
Para sa automatic global scaling nang hindi kinakailangang pamahalaan ang infrastructure, isaalang-alang ang [Cloudflare Workers deployment](/docs/getting-started).
