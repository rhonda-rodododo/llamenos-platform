...
Pour une mise à l'échelle automatique globale sans gérer l'infrastructure, envisagez le [déploiement Cloudflare Workers](/docs/getting-started).
...
Causes courantes : secrets manquants, ADMIN_PUBKEY incorrect, PostgreSQL injoignable, RustFS non prêt.
