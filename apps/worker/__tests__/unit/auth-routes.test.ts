...
const mockHashIP = jest.fn().mockReturnValue('hashed-ip')
...
mock.module('@worker/lib/hub-event-crypto', () => ({
...
function createApp() {
  ...
  const services = {
    identity: {
      ...
      getUserInternal: jest.fn().mockResolvedValue(user),
      hasAdmin: jest.fn().mockResolvedValue({ hasAdmin: false }),
      bootstrapAdmin: jest.fn().mockResolvedValue(undefined),
      updateUser: jest.fn().mockResolvedValue(undefined),
      revokeSession: jest.fn().mockResolvedValue(undefined),
      getWebAuthnCredentials: jest.fn().mockResolvedValue({ credentials: [] }),
      getWebAuthnSettings: jest.fn().mockResolvedValue({
    ...
    settings: {
      ...
      getTranscriptionSettings: jest.fn().mockResolvedValue({ allowUserOptOut: true }),
    },
    audit: {},
  }
